...
from . import li_i2c_expander, sg2_ar0234c_mipi_mode
...
class Ar0234Cam(hololink_module.Synchronizable):
    def __init__(
        ...
        self._mode = sg2_ar0234c_mipi_mode.Sensor_Mode.Unknown
    ...
    def configure_camera(self, sensor_mode_set):
        ...
        if sensor_mode_set.value == sg2_ar0234c_mipi_mode.Sensor_Mode.sensor_mode_1920x1200_raw12_4lane_30fps_linear.value:
            sensor_mode_list = sg2_ar0234c_mipi_mode.sensor_mode_1920x1200_raw12_4lane_30fps_linear
        else:
    ...
    def set_exposure_reg_shs1(self, value=0x0C):
        ...
        # self.set_register(sg2_ar0234c_mipi_mode.SENSOR_I2C_ADDRESS, sg2_ar0234c_mipi_mode.REG_EXP_SHS1_ADDR_MSB, (value >> 16) & 0xFF)
        # self.set_register(sg2_ar0234c_mipi_mode.SENSOR_I2C_ADDRESS, sg2_ar0234c_mipi_mode.REG_EXP_SHS1_ADDR_MID, (value >> 8) & 0xFF)
        # self.set_register(sg2_ar0234c_mipi_mode.SENSOR_I2C_ADDRESS, sg2_ar0234c_mipi_mode.REG_EXP_SHS1_ADDR_LSB, value & 0xFF)
        time.sleep(sg2_ar0234c_mipi_mode.SENSOR_WAIT_MS / 1000)
    ...
    def set_exposure_reg_shs2(self, value=0x0C):
        ...
        # self.set_register(sg2_ar0234c_mipi_mode.SENSOR_I2C_ADDRESS, sg2_ar0234c_mipi_mode.REG_EXP_SHS2_ADDR_MSB, (value >> 16) & 0xFF)
        # self.set_register(sg2_ar0234c_mipi_mode.SENSOR_I2C_ADDRESS, sg2_ar0234c_mipi_mode.REG_EXP_SHS2_ADDR_MID, (value >> 8) & 0xFF)
        # self.set_register(sg2_ar0234c_mipi_mode.SENSOR_I2C_ADDRESS, sg2_ar0234c_mipi_mode.REG_EXP_SHS2_ADDR_LSB, value & 0xFF)
        time.sleep(sg2_ar0234c_mipi_mode.SENSOR_WAIT_MS / 1000)
    ...
    def set_analog_gain_reg(self, value=0x0C):
        ...
        # self.set_register(sg2_ar0234c_mipi_mode.SENSOR_I2C_ADDRESS, sg2_ar0234c_mipi_mode.REG_AG_LSB, (value >> 8) & 0xFF)
        # self.set_register(sg2_ar0234c_mipi_mode.SENSOR_I2C_ADDRESS, sg2_ar0234c_mipi_mode.REG_AG_MSB, value & 0xFF)
        time.sleep(sg2_ar0234c_mipi_mode.SENSOR_WAIT_MS / 1000)

    def set_mode(self, sensor_mode_set):
        if sensor_mode_set.value < len(sg2_ar0234c_mipi_mode.Sensor_Mode):
            self._mode = sensor_mode_set
            mode = sg2_ar0234c_mipi_mode.sensor_frame_format[self._mode.value]
    ...
    def configure_converter(self, converter):
        ...
        if self._pixel_format == hololink_module.sensors.csi.PixelFormat.RAW_12:
            ...
            start_byte += received_line_bytes * 40
        else:
            raise Exception(f"Incorrect pixel format={self._pixel_format} for AR0234.")
        converter.configure(
            start_byte,
            received_line_bytes,
            self._width,
