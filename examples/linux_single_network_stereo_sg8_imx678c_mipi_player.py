...
class HoloscanApplication(holoscan.core.Application):
    ...
    def compose(self):
        ...
        image_processor_left = hololink_module.operators.ImageProcessorOp(
            ...
            # Optical black value for imx678 is 20
            optical_black=20,
...
def main():
    ...
    parser.add_argument(
        "--camera-mode",
        type=int,
        default=hololink_module.sensors.sg8_imx678c_mipi.sg8_imx678c_mipi_mode.Sensor_Mode.SENSOR_MODE_3856X2180_30FPS.value,
        help="IMX678 mode",
    )
    ...
    camera_left = hololink_module.sensors.sg8_imx678c_mipi.sg8_imx678c_mipi.Imx678Cam(
        hololink_channel_left, expander_configuration=0
    )
    camera_right = hololink_module.sensors.sg8_imx678c_mipi.sg8_imx678c_mipi.Imx678Cam(
        hololink_channel_right, expander_configuration=1
    )
    camera_mode = hololink_module.sensors.sg8_imx678c_mipi.sg8_imx678c_mipi_mode.Sensor_Mode(
        args.camera_mode
    )
    ...
    camera_left.get_register(0x1a, 0x3000)
    camera_right.configure(camera_mode)
    camera_right.get_register(0x1a, 0x3000)
