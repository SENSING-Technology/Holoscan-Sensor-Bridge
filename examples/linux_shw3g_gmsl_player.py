...
def main():
    ...
    parser.add_argument(
        "--camera-mode",
        type=int,
        default=hololink_module.sensors.SG10A_AGON_G2M_Ax.shw3g_gmsl_mode.Sensor_Mode.sensor_mode_2064x1552_raw12_30fps.value,
        help="SHW3G-GMSL2 mode",
    )
    ...
    for index in range(len(positions)):
        ...
        if pos in ["front", "back"]:
            camera = hololink_module.sensors.SG10A_AGON_G2M_Ax.shw3g_gmsl.Shw3gCam(
    ...
    camera_mode = hololink_module.sensors.SG10A_AGON_G2M_Ax.shw3g_gmsl_mode.Sensor_Mode(
        args.camera_mode
    )
