...
def main():
    ...
    parser.add_argument(
        "--camera-mode",
        type=int,
        default=hololink_module.sensors.SG10A_AGON_G2M_Ax.sg8_ox08bc_gmsl_mode.Sensor_Mode.sensor_mode_3840x2160_crop_4lane_30fps_linear.value,
        help="SG8-OX08BC-GMSL2 mode",
    )
    ...
    for index in range(len(positions)):
        ...
        if pos in ["front", "back"]:
            camera = hololink_module.sensors.SG10A_AGON_G2M_Ax.sg8_ox08bc_gmsl.Ox08bCam(
    ...
    camera_mode = hololink_module.sensors.SG10A_AGON_G2M_Ax.sg8_ox08bc_gmsl_mode.Sensor_Mode(
        args.camera_mode
    )
