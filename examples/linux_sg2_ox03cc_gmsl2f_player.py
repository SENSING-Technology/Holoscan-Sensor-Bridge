...
def main():
    ...
    parser.add_argument(
        "--camera-mode",
        type=int,
        default=hololink_module.sensors.SG10A_AGON_G2M_Ax.sg2_ox03cc_gmsl2f_mode.Sensor_Mode.sensor_mode_1920x1280_raw12_4lane_30fps_linear.value,
    ...
    for index in range(len(positions)):
        ...
        if pos in ["front", "back"]:
            camera = hololink_module.sensors.SG10A_AGON_G2M_Ax.sg2_ox03cc_gmsl2f.Ox03cCam(
    ...
    camera_mode = hololink_module.sensors.SG10A_AGON_G2M_Ax.sg2_ox03cc_gmsl2f_mode.Sensor_Mode(
        args.camera_mode
    )
